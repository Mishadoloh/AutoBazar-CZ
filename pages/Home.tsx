    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-blue-600 py-12 md:py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 md:mb-6">Знайдіть авто своєї мрії в Чехії</h1>
          <p className="text-blue-100 text-sm md:text-lg mb-8">Найкращі пропозиції від перевірених продавців у Празі, Брно та інших містах</p>
          
          <div className="bg-white p-1.5 rounded-xl shadow-lg flex flex-col md:flex-row gap-2 max-w-3xl mx-auto">
            <input 
              type="text" 
              placeholder="Марка, модель або місто..." 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="lg:hidden mb-6 flex space-x-2">
          <button 
            ...
            className="flex-grow bg-white border border-gray-200 p-3 rounded-xl font-semibold text-gray-700 flex items-center justify-center space-x-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
            <span>{showMobileFilters ? 'Приховати фільтри' : 'Фільтри та сортування'}</span>
          </button>
        </div>

        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Filters */}
          <aside className={`${showMobileFilters ? 'block' : 'hidden'} lg:block w-full lg:w-72 space-y-8 animate-in fade-in lg:animate-none duration-300`}>
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Ціна (EUR)</label>
                ...
                <div className="pt-4">
                  <button 
                    onClick={() => {
                      setFilters({query: '', minPrice: '', maxPrice: '', minYear: '', brand: ''});
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 hidden lg:block">
              <h4 className="font-bold text-blue-800 mb-2">Перевірка VIN</h4>
              <p className="text-sm text-blue-600 mb-4">Перевірте історію автомобіля перед купівлею для вашої безпеки.</p>
              <a href="#/vin-check" className="inline-block w-full text-center bg-blue-600 text-white px-4 py-3 rounded-lg text-sm font-bold">Перевірити зараз</a>
            </div>
          </aside>
          ...
          <div className="flex-grow">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-4 sm:space-y-0">
              <h2 className="text-xl md:text-2xl font-bold text-gray-900">
                Результати <span className="text-gray-500 font-normal text-lg">({filteredCars.length})</span>
              </h2>
              
              <div className="flex items-center space-x-2 w-full sm:w-auto">
                <span className="text-sm text-gray-500 whitespace-nowrap">Сортувати:</span>
                <select 
                ...
                >
                  ...
                  <option value="mileage_asc">Пробіг</option>
                </select>
              </div>
            </div>
            ...
            {filteredCars.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl p-12 text-center border border-dashed border-gray-300">
                <div className="mx-auto w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Нічого не знайдено</h3>
                <p className="text-gray-500">Спробуйте змінити параметри пошуку або скинути фільтри.</p>
              </div>
            )}
          </div>
        </div>
